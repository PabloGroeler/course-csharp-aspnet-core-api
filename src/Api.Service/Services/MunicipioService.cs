...
namespace Api.Service.Services
{
    public class MunicipioService : IMunicipioService
    {
        ...
        public async Task<MunicipioDtoComplete> GetCompleteById(Guid id)
        {
            var entity = await _repository.GetCompleteById(id);
            return _mapper.Map<MunicipioDtoComplete>(entity);
        }

        public async Task<MunicipioDtoComplete> GetCompleteByIbge(int codIbge)
        {
        ...
        public async Task<IEnumerable<MunicipioDto>> GetAll()
        {
            ...
            return _mapper.Map<IEnumerable<MunicipioDto>>(list);
        }
